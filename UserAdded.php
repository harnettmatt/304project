...
if(isset($_POST['submit'])){
    ...
    if(empty($data_missing)){
        ...
        $query1 = "SELECT ID, LastName, FirstName, Phone, Address, UserName, Password, CreditCard,
        Email, AccountType FROM Account";
        ...
        mysqli_stmt_bind_param($stmt, "ssssssssss", $randm, $lname, $fname, $phone, $address, $username,
